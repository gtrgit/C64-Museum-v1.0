import { SavedSceneData } from '../src/utils'

// This file stores the saved scene data
// To update: 
// 1. Use the "Save Scene" button in the UI
  ...
  "planes": [
    {
      ...
      "id": 1758255860643,
      "position": {
        "x": 38.748807593481146,
        "y": 2.989613859840607,
        "z": 5.400760363760532
      },
      "rotation": {
        "x": -0.00311254256565463,
        "y": -0.9957797107539452,
        "z": -0.053137197988962576,
        "w": 0.07476428942953717
      },
      "scale": {
        "x": 4.000000000000003,
        "y": 4.000000000000003,
    ...
    {
      "name": "Template_Plane_1758255860422_725",
      "id": 1758255861083,
      "position": {
        "x": 35.19900676750031,
        "y": 4.193931749760267,
    ...
    {
      "name": "Template_Plane_1758255860422_661",
      "id": 1758255860645,
      "position": {
        "x": 35.2052887987517,
        "y": 4.814629000616718,
    ...
    {
      "name": "Template_Plane_1758255860422_341",
      "id": 1758255860878,
      "position": {
        "x": 35.187042420855235,
        "y": 3.531927839290186,
        "z": 5.984631757700511
      },
      "rotation": {
    ...
    {
      "name": "Template_Plane_1758255860422_730",
      "id": 1758255860638,
      "position": {
        "x": 35.17756572937313,
        "y": 2.8657241426479207,
        "z": 5.914040248908067
      },
      "rotation": {
        "x": -0.00311254256565463,
    ...
    {
      "name": "Template_Plane_1758255860422_968",
      "id": 1758255861130,
      "position": {
        "x": 35.16608930418483,
        "y": 2.133061638893343,
    ...
    {
      "name": "Template_Plane_1758255860422_370",
      "id": 1758255860616,
      "position": {
        "x": 35.15498545430566,
        "y": 1.4579740877555678,
        "z": 5.775305210086751
      },
      "rotation": {
        "x": -0.00311254256565463,
    ...
    {
      "name": "Template_Plane_1758255860422_63",
      "id": 1758255860655,
      "position": {
        "x": 38.63070900422201,
        "y": 1.0970338123130903,
        "z": 5.292691017103585
      },
      "rotation": {
        "x": -0.00311254256565463,
    ...
    {
      "name": "Template_Plane_1758255965142_529",
      "id": 1758255965673,
      "position": {
        "x": 28.102508608033773,
        "y": 3.1598983354232515,
        "z": 7.759932023423675
      },
      "rotation": {
        "x": -0.001998373499406322,
        "y": -0.9796553788439065,
        "z": -0.009161220057878018,
        "w": 0.20046835997910956
      },
      "scale": {
        "x": 4.000000000000003,
        "y": 4.000000000000003,
    ...
    {
      "name": "Template_Plane_1758255965142_578",
      "id": 1758255965852,
      "position": {
        "x": 24.788554967805045,
        "y": 4.346075211756788,
        "z": 9.17566388371919
      },
      "rotation": {
      ...
      "texts": [
        {
          "text": "Albert \"Al\" Charpentier arrived at MOS Technology in 1981 with an extraordinary background from\\nNASA's Goddard Space Flight Center, where he had spent years developing satellite communication\\nsystems and real-time data processing equipment for space missions. His aerospace engineering\\nexperience provided him with a unique perspective on the critical importance of efficiency,\\nminiaturization, and real-time performance under extreme constraints—skills that would prove\\ninvaluable in creating revolutionary computer graphics hardware. Unlike most chip designers of the\\nera who focused primarily on business applications like spreadsheets and word processing,\\nCharpentier understood from his NASA work that computers would increasingly need to excel at visual\\ntasks requiring rapid data manipulation and smooth real-time display updates. His experience with\\nsatellite telemetry systems, where massive amounts of data had to be processed, formatted, and\\ntransmitted within strict timing windows, directly influenced his approach to designing graphics\\nhardware that could handle multiple simultaneous operations without burdening the main processor.\\nThe aerospace industry's emphasis on doing more with less—maximizing performance while minimizing\\npower consumption, heat generation, and component count—became fundamental principles that guided\\nevery aspect of the VIC-II's architecture. Charpentier's NASA background also gave him experience\\nwith specialized processors and custom silicon designed for specific tasks, making him comfortable\\nwith the idea of creating dedicated graphics hardware rather than relying on general-purpose\\nprocessors to handle visual operations through software.",
    ...
    {
      "name": "Template_Plane_1758255965142_340",
      "id": 1758255965490,
      "position": {
        "x": 24.7934311357979,
        "y": 5.001078406650635,
      ...
      "texts": [
        {
          "text": "From NASA to Game-Changing Graphics",
          "fontSize": 1,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255965142_25",
      "id": 1758255965830,
      "position": {
        "x": 24.7836418683113,
        "y": 3.691294286409434,
      ...
      "texts": [
        {
          "text": "Technical Marvel: Sprites, Scrolling, and Collision Detection",
          "fontSize": 0.9,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255965142_636",
      "id": 1758255966101,
      "position": {
        "x": 24.778557594635146,
        "y": 2.981411874712934,
        "z": 9.163457250323887
      },
      "rotation": {
      ...
      "texts": [
        {
          "text": "The Video Interface Controller II (VIC-II) that Charpentier designed in just eight months\\nrepresented a quantum leap beyond anything available in consumer computers, introducing concepts\\nthat would become fundamental to all future graphics systems. The chip's most revolutionary feature\\nwas its hardware sprite system—eight independent graphical objects that could move smoothly across\\nthe screen without affecting the background graphics or requiring CPU intervention. Each sprite\\ncould be 24×21 pixels in size and display up to four colors simultaneously, with the ability to be\\nstretched horizontally or vertically to create larger objects. Most remarkably, the VIC-II\\nautomatically detected collisions between sprites and between sprites and background graphics,\\nsetting interrupt flags that programmers could use to trigger game events—a feature that eliminated\\nthe need for complex software collision detection routines that consumed precious CPU cycles. The\\nchip's smooth scrolling capabilities allowed the entire screen or individual sections to be shifted\\npixel by pixel in any direction, creating the foundation for side-scrolling games and complex visual\\neffects that were impossible on competing systems. Charpentier implemented multiple graphics modes\\nthat could operate simultaneously: a 320×200 high-resolution mode for detailed text and line\\ngraphics, a 160×200 multicolor mode for vibrant artwork, and various text modes with fully\\nprogrammable character sets that allowed developers to create custom fonts and graphical elements.\\nThe VIC-II could display 16 carefully selected colors from a palette designed to work optimally with\\nNTSC and PAL television systems, while advanced features like multicolor sprites could effectively\\ndouble their color depth by sharing color information between adjacent pixels.    ",
          "fontSize": 0.5000000000000001,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255965142_10",
      "id": 1758255966129,
      "position": {
        "x": 24.777033540991063,
        "y": 2.2664634605428935,
        "z": 9.170737303449231
      },
      "rotation": {
        "x": -0.001998373499406322,
      ...
      "texts": [
        {
          "text": "Revolutionary Impact on Gaming and Computer Graphics",
          "fontSize": 1,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255965142_743",
      "id": 1758255965382,
      "position": {
        "x": 24.76794596865988,
        "y": 1.4967668802688243,
        "z": 9.149881903801028
      },
      "rotation": {
        "x": -0.001998373499406322,
      ...
      "texts": [
        {
          "text": "Charpentier's VIC-II didn't just improve computer graphics—it fundamentally transformed what was\\npossible in home computing and established the technological foundation for the entire video game\\nindustry's golden age. Before the VIC-II, computer games were limited to simple, blocky graphics\\nthat moved jerkily across the screen, requiring programmers to manually redraw every frame and\\nmanage complex collision detection through software. The VIC-II's hardware sprites and collision\\ndetection enabled smooth, arcade-quality gameplay that was previously impossible on home computers,\\ndirectly leading to classics like \"The Last Ninja,\" \"Defender of the Crown,\" \"Turrican,\" and\\nthousands of other visually stunning games that defined 1980s gaming culture. The chip's smooth\\nscrolling capabilities made possible the entire genre of side-scrolling platform games, from \"Giana\\nSisters\" to \"Great Giana Sisters,\" while its flexible graphics modes enabled everything from\\ndetailed adventure games to vibrant arcade-style action games. Professional game developers quickly\\nrecognized that the VIC-II's capabilities exceeded those of dedicated arcade hardware costing\\nthousands of dollars, leading to a flourishing industry of C64 game development that produced some\\nof the most creative and technically impressive software of the 8-bit era. The concepts Charpentier\\npioneered—hardware sprites, collision detection, smooth scrolling, and flexible color modes—became\\nstandard features in every subsequent graphics chip, from the Nintendo Entertainment System's PPU to\\nmodern GPU architectures that still use evolved versions of his fundamental innovations. His work\\ndirectly enabled the transformation of computers from business tools into entertainment devices,\\nproving that sophisticated graphics capabilities were essential for personal computers to reach\\nmainstream consumers and establishing the template for all future consumer graphics hardware\\ndevelopment.",
          "fontSize": 0.5000000000000001,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255965142_692",
      "id": 1758255965668,
      "position": {
        "x": 28.022916325530318,
        "y": 1.2638936704282193,
        "z": 7.83940921172003
      },
      "rotation": {
        "x": -0.001998373499406322,
    ...
    {
      "name": "Template_Plane_1758255991336_968",
      "id": 1758255992119,
      "position": {
        "x": 18.606154601647773,
        "y": 3.083191686292024,
        "z": 11.213321171860668
      },
      "rotation": {
        "x": -0.008963687584419244,
        "y": -0.9476113368042915,
        "z": -0.027732298471807977,
        "w": 0.3180936173636187
      },
      "scale": {
        "x": 4.000000000000003,
        "y": 4.000000000000003,
    ...
    {
      "name": "Template_Plane_1758255991336_87",
      "id": 1758255992196,
      "position": {
        "x": 15.760523369038491,
        "y": 4.295179080942864,
        "z": 13.42672201578772
      },
      "rotation": {
      ...
      "texts": [
        {
          "text": "Robert \"Bob\" Yannes brought a unique combination of electrical engineering expertise and deep\\nmusical knowledge to MOS Technology that would prove revolutionary for computer audio. As a trained\\norganist and synthesizer enthusiast, Yannes was acutely aware of the vast gulf between what\\nelectronic music instruments could achieve and the primitive beeps and buzzes that passed for\\ncomputer sound in the early 1980s. His experience with pipe organs had given him profound insights\\ninto envelope shaping, timbre control, and the acoustic principles that make sounds musical rather\\nthan merely functional, while his fascination with analog synthesizers like those made by Moog and\\nARP provided him with technical understanding of oscillators, filters, and modulation. When Yannes\\nencountered the audio capabilities of early computers—simple square wave generators that could\\nbarely produce recognizable pitches, let alone music—he was frustrated by what he saw as a massive\\nmissed opportunity. Unlike other engineers who viewed computer audio as a secondary concern, useful\\nonly for system alerts and simple games, Yannes understood that sound was fundamental to creating\\nengaging, emotional experiences with computers. His musical training told him that if computers were\\ntruly going to become personal and expressive tools, they needed audio capabilities that could match\\nhuman musical sensibilities, not just fulfill basic functional requirements.",
          "fontSize": 0.5000000000000001,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255991336_781",
      "id": 1758255991910,
      "position": {
        "x": 15.784877215343299,
        "y": 4.918836117374433,
        "z": 13.466342385218145
      },
      "rotation": {
        "x": -0.008963687584419244,
        "y": -0.9476113368042915,
      ...
      "texts": [
        {
          "text": "From Church Organs to Silicon Symphonies",
          "fontSize": 1,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255991336_67",
      "id": 1758255991417,
      "position": {
        "x": 15.74020269266926,
        "y": 3.631016600322031,
      ...
      "texts": [
        {
          "text": "Analog Synthesis Concepts Realized in Silicon",
          "fontSize": 1,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255991336_591",
      "id": 1758255992295,
      "position": {
        "x": 15.716999867266425,
        "y": 2.9621545551326283,
        "z": 13.374503576156343
      },
      "rotation": {
        "x": -0.008963687584419244,
        "y": -0.9476113368042915,
      ...
      "texts": [
        {
          "text": "The Sound Interface Device (SID) that Yannes created represented nothing less than a complete analog\\nsynthesizer implemented in a single chip—an engineering feat that had never been attempted before\\nand seemed almost impossible given the technological constraints of early 1980s semiconductor\\nmanufacturing. Each of the SID's three independent oscillators could generate four distinct\\nwaveforms: sawtooth waves for bright, cutting tones; triangle waves for smooth, flute-like sounds;\\nsquare waves with variable pulse width for everything from thin, nasal tones to rich, hollow sounds;\\nand white noise for percussion effects and realistic sound textures. Most remarkably, Yannes\\nincluded sophisticated ADSR (Attack, Decay, Sustain, Release) envelope generators for each voice,\\nallowing sounds to evolve naturally over time like acoustic instruments—a guitar string's sharp\\nattack and gradual decay, or a violin's smooth crescendo and diminuendo. The SID's crowning\\nachievement was its analog filter section: a true 24dB/octave multimode filter with low-pass,\\nhigh-pass, and band-pass settings that could be dynamically controlled and modulated, giving the\\nchip the warm, organic character that purely digital systems couldn't replicate. Advanced features\\nlike ring modulation between oscillators created metallic, bell-like tones, while oscillator\\nsynchronization enabled complex harmonic effects that professional synthesizers used for lead sounds\\nand special effects. Yannes even included two analog-to-digital converters for reading game paddle\\ncontrollers, making the SID a complete audio interface that could both generate and process sound.",
          "fontSize": 0.5000000000000001,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255991337_489",
      "id": 1758255992059,
      "position": {
        "x": 15.700272562252689,
        "y": 2.227536073106882,
        "z": 13.358364810669396
      },
      "rotation": {
        "x": -0.008963687584419244,
        "y": -0.9476113368042915,
      ...
      "texts": [
        {
          "text": "Cultural Revolution and Enduring Musical Influence",
          "fontSize": 1,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255991337_387",
      "id": 1758255992195,
      "position": {
        "x": 15.670699779384329,
        "y": 1.3392701928166428,
        "z": 13.31854157254945
      },
      "rotation": {
        "x": 0.008963686716164562,
        "y": 0.9476112523583069,
        "z": 0.02773230217531121,
        "w": -0.3180935179164026
      },
      "scale": {
        "x": 3.0000000000000018,
      ...
      "texts": [
        {
          "text": "Yannes' SID chip didn't just improve computer audio—it created an entirely new musical genre and\\ninfluenced generations of composers, musicians, and producers worldwide. The chip's unique sonic\\npalette, with its distinctive analog filter character and powerful modulation capabilities, became\\nthe foundation for chiptune music, spawning a cultural movement that elevated video game soundtracks\\nfrom simple accompaniment to legitimate musical art forms. Legendary composers like Rob Hubbard,\\nMartin Galway, and David Whittaker pushed the SID to its absolute limits, creating complex\\ncompositions that rivaled professional synthesizer music of the era through clever programming\\ntechniques like arpeggios, filter sweeps, and creative use of the chip's modulation features. These\\nSID masterpieces—from Hubbard's epic \"Monty on the Run\" theme to Galway's haunting \"Times of Lore\"\\nsoundtrack—became cultural touchstones that defined the sound of 1980s gaming and influenced\\ncountless musicians who would later shape electronic dance music, ambient music, and modern video\\ngame scoring. Today, more than four decades after its creation, the SID's influence permeates\\nelectronic music production, with modern artists and producers actively seeking out original SID\\nchips for their irreplaceable analog character, while software emulations and hardware recreations\\nattempt to capture its distinctive warmth and musicality. Major electronic music festivals regularly\\nfeature chiptune artists performing SID-based compositions, and the chip's sonic DNA can be heard in\\neverything from mainstream pop production to cutting-edge experimental electronic music, proving\\nthat Yannes' frustrated desire to create \"a chip that could make music, not just noise\" resulted in\\none of the most influential and beloved audio devices in the history of electronic music.",
          "fontSize": 0.6000000000000001,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758255991337_179",
      "id": 1758255991384,
      "position": {
        "x": 18.50423424282803,
        "y": 1.2869227263061789,
        "z": 11.248846826438037
      },
      "rotation": {
        "x": -0.008963687584419244,
        "y": -0.9476113368042915,
    ...
    {
      "name": "Template_Plane_1758256008987_507",
      "id": 1758256009978,
      "position": {
        "x": 10.77088818579249,
        "y": 3.0973260684423085,
        "z": 18.09641733025239
      },
      "rotation": {
        "x": -0.014938981513512896,
        "y": -0.8670029178496514,
        "z": -0.026768929514486933,
        "w": 0.4973594072433803
      },
      "scale": {
    ...
    {
      "name": "Template_Plane_1758256008987_313",
      "id": 1758256009572,
      "position": {
        "x": 8.99585120935773,
        "y": 4.288915218264536,
      ...
      "texts": [
        {
          "text": "Charles \"Chuck\" Peddle was already a veteran microprocessor designer at Motorola when he made the\\ndecision that would fundamentally change the economics of computing forever. Frustrated by\\nMotorola's pricing strategy for the 6800 processor, which sold for around $175 per chip—making it\\nprohibitively expensive for all but the most well-funded corporate and government projects—Peddle\\nenvisioned a future where microprocessors could be affordable enough to enable truly personal\\ncomputing. When Motorola's management rejected his proposals for a dramatically lower-cost\\nprocessor, viewing cheap chips as a threat to their high-margin business model, Peddle made the bold\\ndecision to leave along with seven key colleagues and join the small semiconductor company MOS\\nTechnology. There, with the backing of investors who shared his vision of democratizing computing\\npower, Peddle embarked on designing the 6502 with the revolutionary goal of selling it for just\\n$25—less than one-sixth the price of competing processors. This wasn't merely aggressive pricing; it\\nrequired fundamental innovations in chip design, manufacturing processes, and business strategy that\\nwould redefine what was possible in semiconductor economics.",
          "fontSize": 0.6000000000000001,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758256008987_393",
      "id": 1758256009768,
      "position": {
        "x": 9.035151507661865,
        "y": 4.91242921145211,
        "z": 21.262631892080208
      },
      "rotation": {
        "x": -0.014938981513512896,
        "y": -0.8670029178496514,
      ...
      "texts": [
        {
          "text": "Revolutionizing Microprocessor Economics",
          "fontSize": 1,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758256008987_340",
      "id": 1758256009289,
      "position": {
        "x": 8.967384876297748,
        "y": 3.6248427685669715,
        "z": 21.22192254867362
      },
      "rotation": {
        "x": -0.014938981513512896,
      ...
      "texts": [
        {
          "text": "Elegant Simplicity Defeating Complex Competition",
          "fontSize": 0.9,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758256008987_227",
      "id": 1758256009566,
      "position": {
        "x": 8.932188567202914,
        "y": 2.9561017763791204,
        "z": 21.200779088596708
      },
      "rotation": {
        "x": -0.014938981513512896,
        "y": -0.8670029178496514,
    ...
    {
      "name": "Template_Plane_1758256008987_657",
      "id": 1758256009234,
      "position": {
        "x": 8.908657571299047,
        "y": 2.2215558101469526,
        "z": 21.191132601697763
      },
      "rotation": {
        "x": -0.014938981513512896,
        "y": -0.8670029178496514,
      ...
      "texts": [
        {
          "text": "Foundation of the Computing Revolution",
          "fontSize": 1,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758256008987_858",
      "id": 1758256009418,
      "position": {
        "x": 8.864319655170915,
        "y": 1.4434429507382454,
        "z": 21.16463522399706
      },
      "rotation": {
        "x": -0.014938981513512896,
      ...
      "texts": [
        {
          "text": "Peddle's $25 breakthrough didn't just create a successful product—it enabled an entire industry and\\ncultural transformation that continues to shape our world today. The 6502 became the beating heart\\nof the Apple II, making Apple Computer Company possible and launching the careers of Steve Jobs and\\nSteve Wozniak while establishing the template for user-friendly personal computing. When Commodore\\nacquired MOS Technology in 1976, they gained not only the 6502 but also Peddle's cost-conscious\\ndesign philosophy, which directly led to the PET, VIC-20, and ultimately the Commodore 64's\\nrevolutionary $595 price point. The BBC Computer Programme chose the 6502 for the BBC Micro,\\neducating an entire generation of British programmers and establishing the UK as a major force in\\nsoftware development. Nintendo's decision to use a 6502 variant in the Famicom/NES made Peddle's\\narchitecture the foundation of the modern video game industry, powering classics from Super Mario\\nBros. to The Legend of Zelda. Beyond these headline applications, 6502 processors found their way\\ninto thousands of embedded systems, industrial controllers, and specialized computers throughout the\\n1980s and 1990s. Peddle's vision of affordable computing power didn't just create successful\\nproducts—it democratized technology, making computers accessible to schools, small businesses,\\nhobbyists, and families worldwide, fundamentally changing how humanity interacts with information\\nand creating the foundation for everything from the internet revolution to modern smartphones.",
          "fontSize": 0.6000000000000001,
          "font": "sans-serif",
          "textColor": {
            "r": 0,
    ...
    {
      "name": "Template_Plane_1758256008987_587",
      "id": 1758256009461,
      "position": {
        "x": 10.685528809143534,
        "y": 1.3811589996368443,
        "z": 18.165335926916498
      },
      "rotation": {
        "x": -0.014938981513512896,
        "y": -0.8670029178496514,
